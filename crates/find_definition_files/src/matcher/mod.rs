...
mod tests {
    ...
    fn test_get_matcher_for_extension_swift() {
        ...
        assert!(
            matcher.is_some(),
            "Expected a Swift matcher for 'swift' extension"
        );
    ...
    fn test_get_matcher_for_extension_js() {
        ...
        assert!(
            matcher.is_some(),
            "Expected a JS matcher for 'js' extension"
        );
    ...
    fn test_get_matcher_for_extension_objc_h() {
        ...
        assert!(
            matcher.is_some(),
            "Expected an ObjC matcher for 'h' extension"
        );
        let content = r#"
    ...
    fn test_get_matcher_for_extension_objc_m() {
        ...
        assert!(
            matcher.is_some(),
            "Expected an ObjC matcher for 'm' extension"
        );
        let content = r#"
            #import "Message.h"
    ...
    fn test_get_matcher_for_extension_unknown() {
        ...
        assert!(
            matcher.is_none(),
            "Expected no matcher for unsupported extension 'py'"
        );
    }
    ...
    fn test_get_matcher_for_extension_case_insensitivity() {
        ...
        assert!(
            matcher_swift.is_some(),
            "Expected a Swift matcher regardless of case"
        );
        let matcher_js = get_matcher_for_extension("Js");
        assert!(
            matcher_js.is_some(),
            "Expected a JS matcher regardless of case"
        );
    }
}
